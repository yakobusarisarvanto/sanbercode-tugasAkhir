...
When(/^I click more option button on kategori ([^"]*)$/, async (old_name) => {
    await KategoriPage.setKategori(old_name)
    await KategoriPage.moreOptionBtn.click()
})
...
When(/^I click more option button on user ([^"]*)$/, async (old_user) => {
    await PenggunaPage.setPengguna(old_user)
    await PenggunaPage.moreOptionBtn.click()
})
...
When(/^I click more option button on customer ([^"]*)$/, async (old_user) => {
    await PelangganPage.setPelanggan(old_user)
    await PelangganPage.moreOptionBtn.click()
})
